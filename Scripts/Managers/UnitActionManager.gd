...
func _exit_tree() -> void:
	if UnitManager.instance.is_connected("SelectedUnitChanged", self, "_on_unit_manager_selected_unit"):
		UnitManager.instance.disconnect("SelectedUnitChanged", self, "_on_unit_manager_selected_unit")
...
func _unhandled_input(event) -> void:
	if is_busy or UiManager.blocking_input:
		return
...
func try_execute_action(grid_cell: GridCell, unit: Unit, action_to_execute: BaseActionDefinition) -> void:
	...
	_execute_action_internal(action_to_execute, params)
